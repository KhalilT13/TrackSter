...
class SignInFragment : Fragment(R.layout.fragment_signin) {
     ...
     *
     * Clears the entire back stack first (Landing -> Sign In, and any Sign In <-> Sign Up hops)
     * so this becomes the new base screen. Without this, those old entries stay on the stack
     * pointing at a fragment this transaction just removed without going through the back stack
     * itself - pressing Back would then re-add that old fragment on top of whatever's showing,
     * without ever removing it, making both appear at once.
     */

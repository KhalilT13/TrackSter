...
class BookingFragment : Fragment(R.layout.fragment_booking) {
    ...
    private fun onBookClicked(view: View) {
        ...
        createAppointmentTransaction(view, uid, service, date, time)
    }
    ...
    private fun createAppointmentTransaction(view: View, uid: String, selected: ServiceOffering, date: DateOption, time: String) {
        val businessRef = firestore.collection("businesses").document(businessId)
        ...
        firestore.runTransaction { transaction ->
            ...
            val appointment = hashMapOf<String, Any>(
                "customerId" to uid, "businessId" to businessId,
                "serviceId" to currentService.id, "servicePriceType" to currentService.priceType,
